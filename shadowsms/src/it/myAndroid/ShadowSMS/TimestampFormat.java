...
public class TimestampFormat extends Format 
{
  ...
  static public final TimestampFormat getInstance()
  {
	...
	{
		TimeZone tz = TimeZone.getTimeZone ( TimestampFormat.DEFAULT_GMT_TZID );
	...
	public StringBuffer format( Object date, StringBuffer appendTo, FieldPosition fieldPos ) throws IllegalArgumentException
  {
	...
	public Date parseTimestamp( String source )  throws ParseException
	{
		...
		Locale loc = Locale.ITALY;		// UNDONE
